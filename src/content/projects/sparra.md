...
prescription details and previous hospital admissions). A key difference with 
respect of the previous version of the model (SPARRAv3) is the underlying 
modelling approach. SPARRAv4 uses a topic model to extract more granular
information from prescriptions and diagnostic data. Furthermore, it uses an 
ensemble of machine learning models (including boosted decision trees and 
...
recorded primary diagnosis) that are harder to predict. Throughout the project,
our team placed high emphasis on transparency and reproducibility while
ensuring compliance with data governance constraints. This include the use of
TRIPOD reporting guidelines and the sharing of open-source code. 

## Links

- [Liley et al (2024) SPARRAv4: a machine learning model for predicting emergency hospital admissions in Scotland. npj Digital Medicine](https://www.nature.com/articles/s41746-024-01250-1). 
